  ...
  module Infrastructure
    class NFSStorage < OCCI::Core::Resource
      ...
      begin
        ...
        attributes << OCCI::Core::Attribute.new(name = 'occi.storage.size',   mutable = true,   required = false,  type = "string", range = "", default = "")
        attributes << OCCI::Core::Attribute.new(name = 'occi.storage.state',  mutable = false,  required = true,  type = "string", range = "", default = "")
        attributes << OCCI::Core::Attribute.new(name = 'occi.storage.export', mutable = false,  required = true,  type = "string", range = "", default = "")
