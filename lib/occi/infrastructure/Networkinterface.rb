  ...
  module Infrastructure
    class Networkinterface < OCCI::Core::Link
      ...
      begin
        ...
        # Define actions
        ACTION_DOWN = OCCI::Core::Action.new(scheme = "http://schemas.ogf.org/occi/infrastructure/networkinterface/action#", term = "down",      title = "Network Action Down", attributes = [])
        ACTION_UP   = OCCI::Core::Action.new(scheme = "http://schemas.ogf.org/occi/infrastructure/networkinterface/action#", term = "up",        title = "Network Action Up", attributes = [])
