  ...
  module Infrastructure
    class Network
      module Ipnetwork
        ...
        def self.mixin
          mixin = Occi::Core::Mixin.new('http://schemas.ogf.org/occi/infrastructure/network#', 'ipnetwork')

          mixin.title = "IP network mixin"

          mixin.related << Occi::Infrastructure::Network.type_identifier

          mixin.attributes.occi!.network!.address = Occi::Core::AttributeProperties.new(
              { :mutable => true,
          ...
          mixin.attributes.occi!.network!.gateway = Occi::Core::AttributeProperties.new(
              { :mutable => true,
          ...
          mixin.attributes.occi!.network!.allocation = Occi::Core::AttributeProperties.new(
              { :mutable => true,
                :pattern => 'dynamic|static' })

          mixin.location = '/mixins/ipnetwork/'
        ...
        def gateway
          @attributes.occi!.network!.gateway
        end
