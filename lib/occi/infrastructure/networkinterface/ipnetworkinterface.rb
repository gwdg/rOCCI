  ...
  module Infrastructure
    class Networkinterface
      module Ipnetworkinterface
        ...
        def self.mixin
          mixin = Occi::Core::Mixin.new('http://schemas.ogf.org/occi/infrastructure/networkinterface#', 'ipnetworkinterface')

          mixin.title = "IP networkinterface mixin"

          mixin.related << Occi::Infrastructure::Networkinterface.type_identifier

          mixin.attributes.occi!.networkinterface!.address = Occi::Core::AttributeProperties.new(
              { :mutable => true,
          ...
          mixin.attributes.occi!.networkinterface!.gateway = Occi::Core::AttributeProperties.new(
              { :mutable => true,
          ...
          mixin.attributes.occi!.networkinterface!.allocation = Occi::Core::AttributeProperties.new(
              { :mutable => true,
                :pattern => 'dynamic|static' })

          mixin.location = '/mixins/ipnetworkinterface/'
